...
public class BlogContentVerification {
    public static void main(String[] args) throws InterruptedException {
        ...
        List<String[]> urls = readExcelData(".//Excel//BlogsURLList-RDH.xlsx");
    ...
    public static List<String> extractContent(WebDriver driver, String url) throws InterruptedException {
        ...
        List<String> xpaths = Arrays.asList(
                "//*[@class='columns-10 column-center content-column']/p",
                "//*[@class='columns-10 column-center content-column']//li", "//*[@class='columns-10 column-center content-column']//em",
                "//*[@class='columns-10 column-center content-column']//h1", "//*[@class='columns-10 column-center content-column']//h2",
                "//*[@class='columns-10 column-center content-column']//h3", "//*[@class='columns-10 column-center content-column']//h4"
        );
    ...
    public static void saveResultsToExcel(List<String[]> data) {
        ...
        try (Workbook workbook = new XSSFWorkbook()) {
            ...
            File file = new File(".//Excel//BlogsURLList-RDHVerificationReport.xlsx");
