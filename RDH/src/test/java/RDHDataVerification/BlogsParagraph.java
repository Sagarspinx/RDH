...
public class BlogsParagraph {
    public static void main(String[] args) {
        ...
        List<String[]> urls = readExcelData(".//Excel//URLs.xlsx");
        ...
        for (String[] urlPair : urls) {
            ...
            List<String> liveParagraphs = extractParagraphs(driver, liveUrl, "//*[@class='columns-8']//p");
    ...
    public static void saveResultsToExcel(List<String[]> data) {
        ...
        try (Workbook workbook = new XSSFWorkbook()) {
            ...
            File file = new File(".//Excel//CaseStudiesVerificationReport.xlsx");
